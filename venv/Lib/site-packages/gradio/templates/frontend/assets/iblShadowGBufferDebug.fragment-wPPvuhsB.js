...
velocityLinear.b,velocityLinear.a);fragmentOutputs.color=vec4f(velocityLinear.rgb,1.0);} else if (uv.x<=0.75) {fragmentOutputs.color=vec4f(worldPosition.rgb,1.0);} else {fragmentOutputs.color=vec4f(worldNormal.rgb,1.0);}}}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const L={name:e,shader:t};export{L as iblShadowGBufferDebugPixelShaderWGSL};
