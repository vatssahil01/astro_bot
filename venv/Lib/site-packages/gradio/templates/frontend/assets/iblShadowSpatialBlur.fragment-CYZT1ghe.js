...
fragmentOutputs.color= vec4f(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const y={name:e,shader:t};export{y as iblShadowSpatialBlurPixelShaderWGSL};
