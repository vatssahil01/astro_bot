...
const index = 2;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-BbujktD2.js')).default;
const universal = {
  "ssr": false,
  "load": null
};
